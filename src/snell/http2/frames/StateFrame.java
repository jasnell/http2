...
public final class StateFrame 
  extends Frame<StateFrame>
  implements HeaderSet<StateFrame> {
  ...
  public static final class HeadersFrameBuilder extends 
    FrameBuilder<StateFrame,HeadersFrameBuilder>
    ...
    public StateFrame get() {
      
      return new StateFrame(this);
    }
