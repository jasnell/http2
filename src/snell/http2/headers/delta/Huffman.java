...
public final class Huffman {
  ...
  public static void encode(
    ...
    for (char c : data.toCharArray())
      bucket.storeBit32(codeTable.get(c));
  ...
  private static class HuffmanTableBuilder
    ...
    private final ImmutableSortedMap.Builder<IntPair,Character> decode = 
    ...
    private HuffmanTableBuilder add(int c, IntPair pair) {
      ...
      int n = pair.two();
      pair = of(o << (32 - n), n);
      table.put((char)c,pair);
      decode.put(pair,(char)c);
      return this;
    }
  ...
  public static final Huffman REQUEST_TABLE = 
    make()
      ...
      .add(37, of(0x00000026,  6))
      .add(38, of(0x00000070,  7))
      .add(39, of(0x00007ffe, 15))
      .add(40, of(0x00000ff8, 12))
      .add(41, of(0x00000ff9, 12))
      .add(42, of(0x00000ffa, 12))
      .add(43, of(0x00000ffb, 12))
      .add(44, of(0x000003f8, 10))
      .add(45, of(0x00000027,  6))
      .add(46, of(0x00000006,  5))
      .add(47, of(0x00000000,  4))
      .add(48, of(0x00000007,  5))
      .add(49, of(0x00000008,  5))
      .add(50, of(0x00000009,  5))
      .add(51, of(0x00000028,  6))
      .add(52, of(0x00000071,  7))
      .add(53, of(0x00000029,  6))
      .add(54, of(0x00000072,  7))
      .add(55, of(0x0000002a,  6))
      .add(56, of(0x00000073,  7))
      .add(57, of(0x0000002b,  6))
      .add(58, of(0x0000002c,  6))
      .add(59, of(0x000001e8,  9))
      .add(60, of(0x0003fffe, 18))
      .add(61, of(0x0000002d,  6))
      .add(62, of(0x0001fffc, 17))
      .add(63, of(0x000001e9,  9))
      .add(64, of(0x00001ffc, 13))
      .add(65, of(0x000000ec,  8))
      .add(66, of(0x000000ed,  8))
      .add(67, of(0x000000ee,  8))
      .add(68, of(0x000000ef,  8))
      .add(69, of(0x000001ea,  9))
      .add(70, of(0x00000074,  7))
      .add(71, of(0x000001eb,  9))
      .add(72, of(0x000001ec,  9))
      .add(73, of(0x000001ed,  9))
      .add(74, of(0x000003f9, 10))
      .add(75, of(0x000007fa, 11))
      .add(76, of(0x000001ee,  9))
      .add(77, of(0x000001ef,  9))
      .add(78, of(0x000001f0,  9))
      .add(79, of(0x000001f1,  9))
      .add(80, of(0x000001f2,  9))
      .add(81, of(0x000003fa, 10))
      .add(82, of(0x000001f3,  9))
      .add(83, of(0x000001f4,  9))
      .add(84, of(0x000001f5,  9))
      .add(85, of(0x000001f6,  9))
      .add(86, of(0x000001f7,  9))
      .add(87, of(0x000001f8,  9))
      .add(88, of(0x000001f9,  9))
      ...
      .add(95, of(0x0000002e,  6))
      .add(96, of(0x0007fffe, 19))
      .add(97, of(0x0000000a,  5))
      .add(98, of(0x0000002f,  6))
      .add(99, of(0x0000000b,  5))
      .add(100, of(0x00000030, 6))
      .add(101, of(0x00000001, 4))
      .add(102, of(0x00000031, 6))
      .add(103, of(0x00000032, 6))
      .add(104, of(0x00000033, 6))
      .add(105, of(0x0000000c, 5))
      .add(106, of(0x00000075, 7))
      .add(107, of(0x000000f0, 8))
      .add(108, of(0x00000034, 6))
      .add(109, of(0x00000035, 6))
      .add(110, of(0x0000000d, 5))
      .add(111, of(0x0000000e, 5))
      .add(112, of(0x0000000f, 5))
      .add(113, of(0x000001fa, 9))
      .add(114, of(0x00000010, 5))
      .add(115, of(0x00000011, 5))
      .add(116, of(0x00000002, 4))
      .add(117, of(0x00000036, 6))
      .add(118, of(0x000000f1, 8))
      .add(119, of(0x00000037, 6))
      .add(120, of(0x000000f2, 8))
      .add(121, of(0x000000f3, 8))
      .add(122, of(0x000001fb, 9))
  ...
  public static final Huffman RESPONSE_TABLE = 
      ...
      .add(34, of(0x00000068,7))
      .add(35, of(0x00003ffa,14))
      .add(36, of(0x00007ffc,15))
      .add(37, of(0x000001ea,9))
      .add(38, of(0x000003f8,10))
      .add(39, of(0x00001ffc,13))
      .add(40, of(0x000001eb,9))
      .add(41, of(0x000001ec,9))
      .add(42, of(0x00000ffb,12))
      .add(43, of(0x000003f9,10))
      .add(44, of(0x00000026,6))
      .add(45, of(0x00000027,6))
      .add(46, of(0x00000069,7))
      .add(47, of(0x000000e8,8))
      ...
      .add(54, of(0x00000028,6))
      .add(55, of(0x0000000b,5))
      .add(56, of(0x0000000c,5))
      .add(57, of(0x0000000d,5))
      .add(58, of(0x0000000e,5))
      .add(59, of(0x000001ed,9))
      .add(60, of(0x0000fffc,16))
      .add(61, of(0x0000006a,7))
      .add(62, of(0x00003ffb,14))
      .add(63, of(0x00000ffc,12))
      .add(64, of(0x0001fffc,17))
      .add(65, of(0x0000006b,7))
      .add(66, of(0x000001ee,9))
      .add(67, of(0x000000e9,8))
      .add(68, of(0x000000ea,8))
      .add(69, of(0x000000eb,8))
      .add(70, of(0x000000ec,8))
      .add(71, of(0x00000029,6))
      .add(72, of(0x000001ef,9))
      .add(73, of(0x000001f0,9))
      .add(74, of(0x000000ed,8))
      .add(75, of(0x000003fa,10))
      .add(76, of(0x000001f1,9))
      .add(77, of(0x0000002a,6))
      .add(78, of(0x000000ee,8))
      .add(79, of(0x000000ef,8))
      .add(80, of(0x000001f2,9))
      .add(81, of(0x000001f3,9))
      .add(82, of(0x000001f4,9))
      .add(83, of(0x0000006c,7))
      .add(84, of(0x0000000f,5))
      .add(85, of(0x000001f5,9))
      .add(86, of(0x000001f6,9))
      .add(87, of(0x000000f0,8))
      .add(88, of(0x000003fb,10))
      .add(89, of(0x000003fc,10))
      .add(90, of(0x000003fd,10))
      .add(91, of(0x00000ffd,12))
      .add(92, of(0x00003ffc,14))
      .add(93, of(0x000007fc,11))
      .add(94, of(0x00007ffd,15))
      .add(95, of(0x000001f7,9))
      .add(96, of(0x0003fffe,18))
      .add(97, of(0x00000010,5))
      .add(98, of(0x0000006d,7))
      .add(99, of(0x0000002b,6))
      .add(100, of(0x0000002c,6))
      .add(101, of(0x00000011,5))
      .add(102, of(0x0000006e,7))
      .add(103, of(0x0000006f,7))
      .add(104, of(0x00000070,7))
      .add(105, of(0x0000002d,6))
      .add(106, of(0x000001f8,9))
      .add(107, of(0x000001f9,9))
      .add(108, of(0x00000071,7))
      .add(109, of(0x00000072,7))
      .add(110, of(0x0000002e,6))
      .add(111, of(0x0000002f,6))
      .add(112, of(0x00000030,6))
      .add(113, of(0x000001fa,9))
      .add(114, of(0x00000031,6))
      .add(115, of(0x00000073,7))
      .add(116, of(0x00000032,6))
      .add(117, of(0x00000033,6))
      .add(118, of(0x000000f1,8))
      .add(119, of(0x000000f2,8))
