...
public final class OldHuffman2 {

  public static void encode(
    String data, 
    OldHuffman2 codeTable, 
    OutputStream out) 
      throws IOException {
    if (data == null)
      return;
  ...
  private static class HuffmanTableBuilder
    implements Supplier<OldHuffman2> {
    ...
    @Override
    public OldHuffman2 get() {
      return new OldHuffman2(this);
    }
  ...
  protected OldHuffman2(HuffmanTableBuilder builder) {
  ...
  public static final OldHuffman2 REQUEST_TABLE = 
    make()
  ...
  public static final OldHuffman2 RESPONSE_TABLE = 
    make()
